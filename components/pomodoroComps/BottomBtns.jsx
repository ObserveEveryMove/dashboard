            ...
            <div>
                <div className="bottomOuter">
                    ...
                    <button
                        ...
                        className={this.props.timerActive ? "hidePlay" : this.props.nightMode? "nightBtnPlay pomBtn" : "play pomBtn"}>▶</button>

                    <button
                        onClick={this.pauseTimer}
                        className={!this.props.timerActive ? "hidePause" : "pause pomBtn"}>⏸</button>

                    <button
                        onClick={this.resetTimer}
                        className={this.props.nightMode ? "nightBtnRestart pomBtn" : "restart pomBtn"}>↩</button>
